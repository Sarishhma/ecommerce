...
export const TopBar = ({ isHomePage, isScrolled, borderColor, hoverColor }: TopBarProps) => (
  ...
  >
    <div className="container mx-auto px-3 sm:px-6 lg:px-8">
      <div className="flex justify-center sm:justify-between items-center h-8 text-[11px] sm:text-xs text-[#1a1a1a]/70">
        <div className="flex items-center space-x-4 sm:space-x-6">
          <span className="flex items-center font-medium sm:font-normal tracking-wide truncate">
            ✨ Free shipping on orders over $150
          </span>
          <span className="hidden md:flex items-center">🎁 Complimentary gift wrapping</span>
        </div>
