...
export const AccountPage = () => {
    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-ivory via-white to-amber-50/30 flex items-center justify-center px-6">
        <div className="w-full max-w-md text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h2 className=" text-center font-display text-4xl lg:text-5xl font-light tracking-tight text-charcoal">
            Welcome back
          </h2>

          <p className="mt-4 text-sm text-stone/80 leading-relaxed max-w-sm mx-auto">
            Sign in to access your profile, addresses, and account preferences.
          </p>

          <button
            onClick={() => navigate("/login")}
            className="mt-8 px-10 py-4 bg-charcoal text-white rounded-full text-sm font-medium hover:bg-terracotta hover:scale-[1.02] transition-all duration-300 shadow-lg shadow-charcoal/10"
          >
            Sign In
          </button>
        </div>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-ivory via-white to-amber-50/20">
      {/* ───────────────── HEADER ───────────────── */}
      <section className="relative pt-[calc(var(--nav-height)+3rem)] px-6 sm:px-10 lg:px-16 overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto relative">
    ...
    <div className="flex justify-center text-center">
      ...
      <div className="max-w-3xl">
        ...
        <p className="mt-5 mx-auto max-w-xl text-sm lg:text-base text-stone/70 leading-relaxed">
    ...
    <div className="mt-10 h-px bg-gradient-to-r from-transparent via-sand/60 to-transparent" />

  </div>
</section>

      {/* ───────────────── CONTENT ───────────────── */}
      <section className="px-6 sm:px-10 lg:px-16 py-8 lg:py-12 pb-24">
              ...
              <div className="lg:sticky lg:top-[calc(var(--nav-height)+2rem)]">
                ...
                <div className="mt-6">
                  ...
                  <nav className="space-y-1 ">
                    {tabs.map(({ key, label, description, icon: Icon, badge }) => {
                        ...
                        >
                          ...
                          <span
                            className={`
                              ...
                              w-1 rounded-full
                              transition-all duration-300
                              ${active ? "h-8 bg-terracotta" : "h-0 bg-transparent"}
                            `}
                          />
                            ...
                            <div className="flex items-center gap-2">
                              <p
                                className={`text-sm font-medium  transition-colors ${
                                  active ? "text-charcoal" : "text-charcoal/70 group-hover:text-charcoal"
                                }`}
                              >
                                {label}
                              </p>
