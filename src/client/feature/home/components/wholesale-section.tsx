...
export function WholesaleSection({
  ...
  return (
    <section id="shop" ref={ref} className="py-20 lg:py-32 bg-charcoal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl text-ivory text-balance mb-6">
              Bring the beauty of Nepal into your home
            </h2>

            <p className="text-ivory/70 leading-relaxed mb-8">
              Discover authentic, thoughtfully crafted pieces inspired by the
              rich traditions of Nepal. Each piece is made with care, bringing
              timeless craftsmanship and a story worth sharing into your space.
            </p>
          ...
          >
            <div className="aspect-[4/5] relative overflow-hidden rounded-3xl">
              <img
                ...
                alt="A curated collection of Nepalese handcrafted goods"
