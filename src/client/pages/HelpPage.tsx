  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes! We celebrate our artisan partners. Many product pages include stories about the creators. Visit our Story page to learn more about Crystal Clan&apos;s mission to support Himalayan communities.'
      },
      {
...
export const HelpPage = () => {
  ...
  return (
    <div className="pt-24 pb-20 lg:pt-32 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div ref={contentReveal.ref as React.RefObject<HTMLDivElement | null>} className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        <a href="mailto:support@crystalclan.com" className="p-6 bg-white rounded-2xl border border-sand/50 shadow-sm hover:shadow-md transition-shadow text-center hover:border-terracotta/50">
          ...
          <p className="text-sm text-stone mb-3">support@crystalclan.com</p>
